...
void sendMP3Command(char c) {
  switch (c) {
    ...
    case '2':
      ...
      //sendCommand(CMD_FOLDER_CYCLE, 0x02); //should not put '01' behind each 0 x 02
      sendCommand(CMD_PLAY_FOLDER_FILE, 0x0202);  // Play file in folder 2 with index
      break;

    case '3':
      Serial.println("Play folder 3");
      //sendCommand(CMD_FOLDER_CYCLE, 0x03);
      sendCommand(CMD_PLAY_FOLDER_FILE, 0x0303);  // Play file in folder 3 with index 003
      break;

    case '4':
      Serial.println("Play folder 4");
      sendCommand(CMD_SNG_CYCL_PLAY, 0x0404);  // Play file in folder 4 with index 004 on loop
      break;
